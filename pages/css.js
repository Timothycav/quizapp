...
export default function Home() {
  ...
  const handleAnswer = (selectedOption) => {
    const isCorrect = selectedOption === cssquestions[currentQuestion].correctAnswer;
  ...
  return (
    ...
    <Image src="/icon-css.svg" alt="Logo" width={40} height={40} />   CSS </h1>
                  <div div className={styles.main}> 
    
    {currentQuestion < cssquestions.length ? (
        <>
        ...
        <p>
         ...
         <h2 className={styles.currentQ}>  {cssquestions[currentQuestion].question}  </h2>
            ...
            {cssquestions[currentQuestion].options.map((option, index) => (
              <li className={styles.choice}
                ...
                style={{
                  ...
                  backgroundColor:
                    userChoice === option
                      ? option === cssquestions[currentQuestion].correctAnswer
                        ? 'green'
                        : 'red': '',
